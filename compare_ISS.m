% This is a script to create the ISS example (Figure 3) of our paper.
% The code for balancing Bayesian inference is taken from 
...
for t = 1:T_length
    ...
    [~,~,~,~,ST,YST]    = RKSM_tlbt(A',M',F',3,[tol,tol,eps],maxit,'convR',[],[],T(t),[],[],opts);
